...
// merupakan program les privat yang memudahkan siswa untuk belajar. Dalam program ini terdapat 3 fitur utama, yaitu admin, siswa dan juga pengajar. Fitur admin digunakan sebagai penyedia akses aplikasi. Fitur pengajar digunakan untuk memudahkan akses dengan siswanya dan fitur siswa digunakan sebagai konsumen aplikasi. Siswa dapat memilih fitur yang sudah disediakan oleh admin. Berikut merupakan rincian program

// 1. ADMIN
// 	- Login Admin (username dan password)
// 	- Melihat data siswa yang daftar
// 	- Menambahkan jenjang pendidikan
// 	- Menambahkan paket belajar berdasarkan jenjang pendidikan (guru + mapel)
// 	- Menambahkan jadwal belajar bagi para siswa
// 	- Menghitung penghasilan admin dan pengajar (40% admin, 60% pengajar)
// 	- Melihat penghasilan admin
// 	- log out

// 2. SISWA
// 	- Login siswa(maksimum 3 kali)
// 	- Melihat helpdesk menggunakan D'COURSE
// 	- Melihat daftar paket belajar yang telah diurutkan 
// 	- Memilih daftar paket belajar
// 	- Membayar daftar paket belajar
// 	- Memilih jadwal belajar
// 	- Melakukan pembayaran 
// 	- Melihat review dan masukan (penilaian) yang diberikan oleh pengajar kepada siswa
// 	- Log Out

// 3. PENGAJAR
// 	- Login 
// 	- Melihat daftar siswa yang masuk di jadwal
// 	- Memberikan feedback ke siswa
// 	- Melihat gaji
// 	- Log out
